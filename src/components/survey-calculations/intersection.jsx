...
export default function OffsetIntersectionUI() {
  ...
  const axisOffsetX = 280; // move vertical text left

  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
      <svg width="700" height="700">

        {/* Axis line (dash + 3 dots) */}
        <line
          x1="300"
          y1="50"
          x2="300"
        ...
        {result && (
          <>
            ...
            <text x={result.X.x + 10} y={result.X.y} fill="red">X</text>
          </>
        )}
